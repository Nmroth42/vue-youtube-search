<template>
    <div class="VideoDetail">
        <div class="VideoDetail-nav">
            ...
            <span onclick="history.back();">  back to list </span>
        </div>
        <div class="videoPanel">
            ...
            class="embed-responsive horizontal-alignment  embed-responsive-16by9">
                <iframe v-bind:src="url" allowfullscreen frameborder="0" 
